              ...
              @method('PUT')
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Date:</label>
                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                          <input type="text" name="date_of_birth" value="{{$profile->date_of_birth}}" class="form-control datetimepicker-input" data-target="#reservationdate">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="university" class="form-control" id="exampleInputPassword1" value="{{$profile->university}}" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Year</label>
                    <input type="text" name="year" class="form-control" id="exampleInputPassword1" value="{{$profile->year}}" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Skill</label>
                    <input type="text" name="skills" class="form-control" id="exampleInputPassword1" value="{{$profile->skills}}" required>
                  </div>
                </div>
                <!-- /.card-body -->
